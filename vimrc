...
let g:LookupFile_AllowNewFiles = 0              "不允许创建不存在的
...
let Tlist_Use_Right_Window = 1  "window appear on the right
let Tlist_GainFocus_On_ToggleOpen = 1 "cursor is moved to the taglist window
let Tlist_WinHeight = 20
let Tlist_Exit_OnlyWindow = 1 "exit Vim if only the taglist window is currently opened
